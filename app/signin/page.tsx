...
export default function Login() {
  ...
  const handleSubmit = async(e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // await queryClient.invalidateQueries({ predicate: [['currentUser']] });

      toast.success("Token stored successfully");
      } else {
       console.error('Token received is not a string:', token);
      toast.error("Token received is not valid");
      }
    } catch (error) {
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 bg-white rounded-md shadow-md lg:max-w-xl">
        ...
        <form className="mt-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-2">
            <button
              type="submit" // Add type="submit" to trigger form sub
